...
#
# Config file precedence (all merge, override in order):
#
# app-config.yaml
# app-config.production.yaml
# app-config.preset-{name}.yaml (one per VEECODE_PRESETS entry, in order)
# app-config.distro.yaml
# app-config.local.yaml (from VEECODE_APP_CONFIG or manual)
# dynamic-plugins-root/app-config.dynamic-plugins.yaml (generated by install script)
# app-config.saas.yaml
#
